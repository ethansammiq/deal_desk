      ...
      <div className="space-y-8">
        ...
        {userRole === 'seller' ? (
          <div className="grid gap-6 lg:grid-cols-2">
            {/* My Pipeline - Now a dedicated component */}
            <PipelineSection 
              deals={deals}
          ...
          /* Non-Seller Roles - Enhanced with ActionItemsSection */
          <div className="grid gap-6 lg:grid-cols-2">
            <ActionItemsSection
              deals={deals}
              userRole={userRole}
        ...
        {/* Recent Deals Table - For All Roles */}
        <Card className="border border-slate-200 shadow-sm bg-white">
          <CardHeader className="pb-6">
            <div className="flex items-center gap-3">
              <div className="w-1 h-6 bg-[#3e0075] rounded-full"></div>
              <div className="flex-1">
                <CardTitle className="text-xl font-semibold text-slate-900">Recent Deals</CardTitle>
                <CardDescription className="text-slate-500">
                  Latest deal activity and updates
                </CardDescription>
              </div>
            </div>
          </CardHeader>
