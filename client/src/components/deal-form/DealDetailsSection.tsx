...
interface DealDetailsSectionProps {
  ...
  showPriorityField?: boolean; // New prop to control Priority field visibility
...
export function DealDetailsSection({
  ...
  showPriorityField = false, // Default to false, only SubmitDeal will set to true
    ...
    <div className="p-6">
      ...
      <div className="space-y-6">
        ...
        {showDealStructure && (
          ...
          {/* Priority Selection - Only show when explicitly enabled */}
          {showPriorityField && (
            <FormField
              control={form.control}
              name="priority"
