    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardContent className="p-6">
          ...
          {/* Financial Summary Section - Matching Original Design */}
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <colgroup>
                  ...
                  <col className="w-[20%]" />
                  {dealTiers.map((tier) => (
                    <col key={`summary-col-${tier.tierNumber}`} className="w-[20%]" />
                  ))}
                </colgroup>
                
                <thead>
                  <tr>
                    <th className="text-left p-3 bg-gray-50 border border-gray-200"></th>
                    <th className="text-center p-3 bg-gray-50 border border-gray-200 font-medium text-gray-700">
                      Last Year
                    </th>
                    {dealTiers.map((tier) => (
                      <th key={`summary-header-${tier.tierNumber}`} className="text-center p-3 bg-gray-50 border border-gray-200 font-medium text-gray-700">
                        Tier {tier.tierNumber}
                      </th>
                    ))}
                  </tr>
                  ...
                  <tr>
                    <td className="p-3 border border-gray-200">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Gross margin after incentives</div>
                      </div>
                    </td>
                    ...
                    {dealTiers.map((tier) => {
                      const adjustedMargin = tier.annualRevenue && tier.incentiveValue 
                        ? ((tier.annualRevenue - tier.incentiveValue) / tier.annualRevenue) * 100
                        : 0;
                      return (
                        <td key={`adj-margin-${tier.tierNumber}`} className="p-3 border border-gray-200 text-center font-medium">
                  ...
                  <tr>
                    <td className="p-3 border border-gray-200">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Gross profit after incentive costs</div>
                      </div>
                    </td>
                    <td className="p-3 border border-gray-200 text-center font-medium">
                      $1,879,600
                    ...
                    {dealTiers.map((tier) => {
                      const adjustedProfit = (tier.annualRevenue || 0) - (tier.incentiveValue || 0);
                      return (
                        <td key={`adj-profit-${tier.tierNumber}`} className="p-3 border border-gray-200 text-center font-medium">
                  ...
                  <tr>
                    <td className="p-3 border border-gray-200">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Percentage change in adjusted margin</div>
                      </div>
                    </td>
                    <td className="p-3 border border-gray-200 text-center font-medium text-gray-500">
                      —
                    </td>
                    {dealTiers.map((tier) => {
                      const currentMargin = tier.annualRevenue && tier.incentiveValue 
                        ? ((tier.annualRevenue - tier.incentiveValue) / tier.annualRevenue) * 100
                        : 0;
                      ...
                      return (
                        <td key={`margin-growth-${tier.tierNumber}`} className={`p-3 border border-gray-200 text-center font-medium ${isNegative ? 'text-red-600' : 'text-green-600'}`}>
                          {growthRate.toFixed(1)}%
                        </td>
                      );
                    })}
                  ...
                  <tr>
                    <td className="p-3 border border-gray-200">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Percentage increase in adjusted profit vs last year</div>
                      </div>
                    </td>
                    <td className="p-3 border border-gray-200 text-center font-medium text-gray-500">
                      —
                    ...
                    {dealTiers.map((tier) => {
                      const currentProfit = (tier.annualRevenue || 0) - (tier.incentiveValue || 0);
                      ...
                      const isNegative = growthRate < 0;
                      return (
                        <td key={`profit-growth-${tier.tierNumber}`} className={`p-3 border border-gray-200 text-center font-medium ${isNegative ? 'text-red-600' : 'text-green-600'}`}>
                          {growthRate.toFixed(1)}%
                        </td>
                      );
                    })}
