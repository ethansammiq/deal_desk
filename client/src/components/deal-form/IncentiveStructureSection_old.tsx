...
// ❌ ELIMINATED: TierIncentive and SelectedIncentive imports - using DealTier only
...
interface IncentiveStructureSectionProps {
  ...
  // ❌ ELIMINATED: SelectedIncentive and TierIncentive - using DealTier as single source of truth
...
export function IncentiveStructureSection({
  ...
  dealTiers,
  setDealTiers,
  // ❌ ELIMINATED: selectedIncentives, setSelectedIncentives, tierIncentives, setTierIncentives
  ...
  // ❌ ELIMINATED: Calculation now uses DealTier directly
