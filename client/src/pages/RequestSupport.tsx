...
const dealScopingSchema = z.object({
  ...
  growthOpportunityMIQ: z.string().min(1, "Please describe the growth opportunity from MIQ's perspective"),
  growthAmbition: z.number().min(1000000, "Growth ambition must be at least $1M"),
  growthOpportunityClient: z.string().min(1, "Please describe the client's growth objectives"),
  clientAsks: z.string().optional(),
});

// Define a more specific type based on schema
type DealScopingFormValues = z.infer<typeof dealScopingSchema>;

// Define advertiser and agency types (these would typically come from your schema)
