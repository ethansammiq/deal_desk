...
async function generateAIResponse(message: string, storage: IChatStorage): Promise<string> {
  ...
  const keywordMappingImport = {
    ...
    reviewProcess: ['review', 'approval', 'approve', 'evaluate', 'assessment', 'appraise',
    ...
    approvalFramework: ['approval framework', 'approval matrix', 'who approves', 'approval hierarchy',
